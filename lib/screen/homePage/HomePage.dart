...
class _HomePageState extends State<HomePage> {
 ...
 final Stream<QuerySnapshot> _usersStream = FirebaseFirestore.instance.collection('PackageServices').where("user_id",isEqualTo:FirebaseAuth.instance.currentUser!.uid).snapshots();
